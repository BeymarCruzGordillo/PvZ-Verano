...
#include "PvZ_B/Observer_Principal.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PVZ_B_API UClass* Z_Construct_UClass_AObserver_Principal_NoRegister();
	PVZ_B_API UClass* Z_Construct_UClass_AObserver_Principal();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AObserver_Principal_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Observer_Principal.h" },
		{ "ModuleRelativePath", "Observer_Principal.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(AObserver_Principal, 2197806560);
	template<> PVZ_B_API UClass* StaticClass<AObserver_Principal>()
	{
		return AObserver_Principal::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AObserver_Principal(Z_Construct_UClass_AObserver_Principal, &AObserver_Principal::StaticClass, TEXT("/Script/PvZ_B"), TEXT("AObserver_Principal"), false, nullptr, nullptr, nullptr);
